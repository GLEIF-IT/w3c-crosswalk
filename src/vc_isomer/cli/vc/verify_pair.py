...
from vc_isomer.cli.common import add_live_signer_args, add_verifier_wait_args, load_passcode, load_token_argument, response_for_doers
from vc_isomer.isomer_runtime import IsomerRuntimeDoDoer
from vc_isomer.verifier_client import verify_pair_doer
...
def handle(args: argparse.Namespace):
    """Return doers for `isomer vc verify-pair`."""
