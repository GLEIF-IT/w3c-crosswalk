...
from vc_isomer.isomer_runtime import IsomerRuntimeDoer
from vc_isomer.services import project_status
...
def handle(args: argparse.Namespace):
    """Return doers for `isomer status project`."""
...
def add_project_command(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    """Register `isomer status project`."""
