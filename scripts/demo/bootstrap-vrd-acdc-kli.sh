...
WITNESS_OOBI_WAN="${WITNESS_OOBI_WAN:-http://127.0.0.1:5642/oobi/BBilc4-L3tFUnfM_wJr4S4OJanAv_VmF_dJNN6vkf2Ha}"
WITNESS_OOBI_WIL="${WITNESS_OOBI_WIL:-http://127.0.0.1:5643/oobi/BLskRTInXnMxWaGqcpSyMgo0nYbalW99cGZESrz3zapM}"
WITNESS_OOBI_WES="${WITNESS_OOBI_WES:-http://127.0.0.1:5644/oobi/BIKKuvBwpmDVA4Ds-EpL5bt9OqPzWPja2LigFYZN2YfX}"
